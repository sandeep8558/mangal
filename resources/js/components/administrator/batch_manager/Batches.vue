            ...
            formData : {
                ...
                elements : [
                    ...
                    },
                    {
                        ...
                        ObjectValue : {},
                        options : [
                            { key : 'Select Syllabus', value : '' },
                            { key : 'Pending', value : 'Pending' },
                            { key : 'Completed', value : 'Completed' },
                        ],
                        placeholder : 'Please Select Syllabus',
                        type : 'select',
                        validation : 'required',
                        class : 'col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-3',
                        labelClass : '',
                        hint : 'Please Select Syllabus',
                        error : '',
                        isError : false,
                        readonly : false,
                    },
                    {
                        ...
                        ObjectValue : {},
                        options : [
                            { key : 'Select Mark Entry', value : '' },
                            { key : 'Pending', value : 'Pending' },
                            { key : 'Completed', value : 'Completed' },
                        ],
                        placeholder : 'Please Select Mark Entry',
                        type : 'select',
                        validation : 'required',
                        class : 'col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-3',
                        labelClass : '',
                        hint : 'Please Select Mark Entry',
                        error : '',
                        isError : false,
                        readonly : false,
                    },
