...
export default {
    ...
    data: function (){
        return {
            formData : {
                id : 0,
                title : "SalaryHistory Manager",
                formName : "SalaryHistoryForm",
                model : "SalaryHistory",
                ...
                display : [
                    { key : 'staff_id', val : 'Staff ID', type : 'text' },
                    { key : 'salary_group_id', val : 'Salary Group ID', type : 'text' },
                    { key : 'effective_from', val : 'Effective From', type : 'text' },
                    { key : 'effective_till', val : 'Effective Till', type : 'text' },
                    { key : 'remark', val : 'Remark', type : 'text' },
                ...
                elements : [
                    ...
                    },
                    {
                        ...
                        values : [],
                        ObjectValue : {},
                        options : this.salary_groups,
                        placeholder : 'Please Select Salary Group',
                        type : 'select',
                        validation : 'required',
                        class : 'col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8 mb-3',
                        labelClass : '',
                        hint : 'Please Select Salary Group',
                        error : '',
                        isError : false,
                        readonly : false,
                    },
