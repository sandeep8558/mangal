    ...
    data: function (){
        return {
            formData : {
                ...
                display : [
                    { key : 'order', val : 'Order', type : 'text' },
                    { key : 'category', val : 'Category', type : 'text' },
                    { key : 'typeof', val : 'Type', type : 'text' },
                ...
                elements : [
                    ...
                    },
                    {
                        ...
                        ObjectValue : {},
                        options : [
                            { key : 'Select Type of', value : '' },
                            { key : 'Course', value : 'Course' },
                            { key : 'Tuition', value : 'Tuition' },
                        ],
                        placeholder : 'Please Select Type of',
                        type : 'select',
                        validation : 'required',
                        class : 'col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-3',
                        labelClass : '',
                        hint : 'Please Select Type of',
                        error : '',
                        isError : false,
                        readonly : false,
                    },
